        ...
        <div v-if="show" class="wc-messagebox">
            <div class="wc-messagebox-popup wc-messagebox-popup-in">
                <div class="wc-messagebox-popup-inner">
                    ...
                    <div class="wc-messagebox-popup-input">
    ...
    export default {
        ...
        mounted () {
            setTimeout(()=>{
                ...
                document.querySelector('.wc-messagebox-popup-input input').focus();
                // alert(document.querySelector('.wc-messagebox-popup-input input'))
            },400)
